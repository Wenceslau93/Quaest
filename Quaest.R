...
# Para começar, vamos definir e conferir o diretório de trabalho. Este diretório precisa ser da sua máquina.
...
# Na maioria dos casos, não tivermos muita diferença entre os votos dos homens e mulheres.
...
# Aqui podemos ver uma enorme diferença de votos do Candidato 2 aos demais candidatos.
df %>%
  group_by(voto1) %>%
  summarise(n = n()) %>%
...
# Ninguém/Branco/Nulo, NS/NR, Candidato 8, teve mais avaliação negativa
